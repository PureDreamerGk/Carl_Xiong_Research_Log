...
- [X] Give give feedback on your peers' proposals and post the feedback on to your ERSP Google Drive folder (under your individual sub folder) and also link it from your research log

- [x] Bring the feedback to class to discuss with peers

- [x] Revise porposal based on : (1)The peer review feedback you received, (2) the grading rubric (3) Any feedback you have received from your advisor.

- [x] Share the revised proposal (with revision notes) with Chinmay
...
- [X] Finish Reflection 3

- [X] Continue and Finish the porposed solution part for porposal

- [X] Continue doing experiment with the existed code and compare the performance of bmw and tp on scores generated by BM25 and Deep Impact.

- [X] writing the Evaluation and Implementation Plan section and be ready for peer review

**Notes and Questions**:

TBD

# Tuesday, Nov 16 (2 hrs)

* writing the Evaluation and Implementation Plan section and be ready for peer review
* Attend the research group meeting as scheduled and record attendance

# Saturday, Nov 13 (2hrs)
...
- [x] Continue the draft of proposal by adding the Proposed Solution section. Describe the specific work we will be doing, and explain how that work is a solution to the problem you laid out in the first section.

- [x] Running existed code with the score generated by deepimpact. Compare the performance of bmw on these scores and scores generated by BM25.
...
# Tuesday, Nov 8 (3.5 hrs)

* Write a python script that automaticaaly run code with different input for block size, top k, method used for the current coding based.
* Generate graph that demonstrate the efficiency difference of bmw, tp on score generated by deep impact and BM25
* Due to the Ventura days, we decided to move our meeting to today and discuss activities done in the past week
* Graph for efficiency difference of bmw and tp with the score generated by BM25:
![2471636872873_ pic_hd](https://user-images.githubusercontent.com/34769184/141670812-40204474-4cd2-474d-96c0-002805fe487d.jpg)
* Graph for efficiency difference of bmw and tp with the score generated by DeepImpact:
![2481636872877_ pic_hd](https://user-images.githubusercontent.com/34769184/141670829-01c32f2c-8e35-41cb-8b09-21015e0cfcf0.jpg)
* Graph for efficiency difference of bmw between the score generated by BM25 and DeepImpact:
![2491636873067_ pic_hd](https://user-images.githubusercontent.com/34769184/141670848-536f4507-1bbd-45d0-85c4-af86bbc2052f.jpg)
* Graph for efficiency difference of tp between the score generated by BM25 and DeepImpact:
![2501636873071_ pic_hd](https://user-images.githubusercontent.com/34769184/141670869-edc5e296-4c94-4d88-b945-2d49190371db.jpg)



# Saturday, Nov 6 (1.5 hrs)

* Brainstorm on possible solution and continue running existed code with the score generated by deep impact.



# Thursday, Nov 4 (1.5 hrs)

* Refine the porposal draft for research context and problem statement.
* Attend the reserach and discuss question regarding code generated by Deep Impact.
