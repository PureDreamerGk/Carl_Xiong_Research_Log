...
- [ ] Continue the draft of proposal by adding the Proposed Solution section. Describe the specific work we  will be doing, and explain how that work is a solution to the problem you laid out in the first section.

- [ ] Running existed code with the score generated by deepimpact. Compare the performance of bmw on these scores and scores generated by BM25.
